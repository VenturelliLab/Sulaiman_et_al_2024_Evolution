...
train_df = pd.read_csv(f"folds_CDevo/train_{outer}_{trial}.csv")
test_df = pd.read_csv(f"folds_CDevo/test_{outer}_{trial}.csv")
...
# save dataframe
pred_df.to_csv(f"CDevo_pred_{outer}_{lmbda}_{trial}.csv", index=False)
