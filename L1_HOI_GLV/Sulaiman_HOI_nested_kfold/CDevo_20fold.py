...
train_df = pd.read_csv(f"folds_CDevo/train_{outer}_{inner}.csv")
test_df = pd.read_csv(f"folds_CDevo/test_{outer}_{inner}.csv")
...
# save dataframe
pred_df.to_csv(f"CDevo_pred_{outer}_{inner}_{lmbda}.csv", index=False)
