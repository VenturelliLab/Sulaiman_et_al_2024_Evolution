...
hyper_df = pd.read_csv("CDanc_hyper_df.csv")
lmbda = hyper_df.iloc[hyper_df.k.values == int(k)].values[0][1:][0]

# import train and test data
train_df = pd.read_csv(f"folds_CDanc/train_{k}.csv")
test_df = pd.read_csv(f"folds_CDanc/test_{k}.csv")
...
# save dataframe
pred_df.to_csv(f"CDanc_pred_{k}.csv", index=False)
